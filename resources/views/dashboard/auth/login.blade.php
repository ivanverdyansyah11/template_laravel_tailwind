...
@section('content-auth')
    ...
    <div class="container w-full flex justify-center mt-12">
        <div class="flex flex-col items-center w-full md:w-[50%] lg:w-[35%] xl:w-[30%] 2xl:w-[25%]">
            ...
            @endif
            <h2 class="w-full text-[2.25rem] mb-[2px] font-bold">Login 👋🏻</h2>
            <p class="w-full text-[0.875rem] mb-[32px] text-dark-62">Log in to your account to access all our features and services.</p>
            <form class="form flex flex-col gap-3 w-full">
                ...
                <button type="submit" class="button-primary group">Login Account</button>
                <p class="link-redirect">Don't have an account? <a href="{{route('auth.register')}}">Create Account</a></p>
            </form>
        </div>
    </div>
@endsection
